        ...
        {companyData.map((company, index) => (
          <div key={index} className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="font-medium text-gray-800">{company.company}</div>
                <div className="text-sm text-gray-500">{company.applications} applications</div>
              </div>
            </div>
            <div className="text-right">
              <div className="font-bold text-purple-600">{company.offers} offers</div>
              <div className="text-sm text-gray-500">{company.successRate}% success</div>
            </div>
          </div>
        ))}
      </div>
